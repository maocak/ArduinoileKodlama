...
int notasayisi1 =10; //1. dizi için kullanılacak nota sayısı tanımlanır.
int notasayisi2 =12; //2. dizi için kullanılacak nota sayısı tanımlanır.  
...
int dizi1[] = {Fa,Sol,Sol,Fa, Mi, Re, Fa, Mi, Re, Re}; //1.dizideki notalar
int dizi2[]= {La, Sol, La, Fa, Sol, Fa, Mi, Re, Fa, Mi, Re, Re}; //2.dizideki notalar
...
void loop()
{
for (int i = 1; i <= notasayisi1; i++) //1. dizide bulunan 10 notanın sırasıyla çalması için döngü kullanılır. 
{
...
for (int i = 1; i <= notasayisi2; i++)//2. dizide bulunan 12 notanın sırasıyla çalması için döngü kullanılır. 
{
...
for (int i = 1; i <= notasayisi3; i++)//3. dizide bulunan 22 notanın sırasıyla çalması için döngü kullanılır. 
{
...
for (int i = 1; i <= notasayisi4; i++)//4. dizide bulunan 20 notanın sırasıyla çalması için döngü kullanılır. 
{
